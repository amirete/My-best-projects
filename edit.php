<?php
	...
	if(isset($_POST['edit'])){
		...
		try{
			...
			$sql = "UPDATE members SET gpname = '$gpname', pjname = '$pjname', avg = '$average', percent = '$percent' WHERE id = '$id'";
			//if-else statement in executing our query
			$_SESSION['message'] = ( $db->exec($sql) ) ? 'گروه با موفقیت بروز رسانی شد.' : 'Something went wrong. Cannot update member';
